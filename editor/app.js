var app = angular.module('app',['ngMaterial'])
    .controller('mainCtrl',['$scope','$http','$mdDialog',function($scope,$http,$mdDialog){
        ...
        $scope.update = {
            move:function(level_ind,pattern_ind, set, dir){
                $scope.levels[level_ind].patterns[pattern_ind].sets.move(set,dir);
            },
            copy:function(ev,patern){
                $mdDialog.show({
                    template: '<md-dialog aria-label="Move to Level"><md-dialog-content><move levels="'+$scope.levels.length+'"></move></md-dialog-content></md-dialog>',
                    parent: angular.element(document.body),
                    targetEvent: ev,
                    clickOutsideToClose:true
                })
                    .then(function(answer) {
                        $scope.levels[answer].patterns.push(patern);
                    }, function() {
