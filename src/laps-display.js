define([
    ...
    function LapsDisplay (_game, x, y) {
        ...
        this.lap = 0;
        this.lapsText = new Phaser.Text(game, game.width - 50, 0, this.distanceString, { font: "bold 16px Arial", fill: "#000", boundsAlignH: "center", boundsAlignV: "middle" });
    ...
    LapsDisplay.prototype.updateDisplay = function (val) {
        this.lap = val;
        this.lapsText.setText("Lap " + Math.floor(this.lap));
    };
